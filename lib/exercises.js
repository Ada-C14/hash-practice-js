...
function top_k_frequent_elements(list, k) {
  ...
  const sorted = Object.keys(numberCount).sort((num1, num2) => numberCount[num2] - numberCount[num1]);
  // following does not work because js at some point converts the keys to strings // return sorted.slice(0, k);
